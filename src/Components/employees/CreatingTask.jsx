...
const CreatingTask = ({handleFinishAdding,admin, employee}) => {
    ...
    return (
        <form onSubmit={handleNewTask} className="bg-green flex justify-around tie font-bold">
            <div className="flex flex-col justify-around gap-3">
                <div className=" h-1/6 text-xl flex gap-5 items-center justify-between">
                    ...
                    <textarea onChange={handleTask} type='text' className='outline-red-950 p-2 bg-zinc-100 text-red-950' cols="50" rows="8"/>
                </div>
            </div>
